...
/*   Updated: 2023/05/29 19:09:03 by yamajid          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	help_move_function(char *line, t_player *player, t_map *map)
{
	int	i;
...
void	ft_top_move(t_map *map)
{
	...
	if (move.line[move.i] == 'C' || move.line[move.i] == '0')
		help_move_function(move.line, move.player, map);
